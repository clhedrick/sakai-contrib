/**********************************************************************************
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-tool/src/java/org/etudes/jforum/JForumSynopticAction.java $ 
 * $Id: JForumSynopticAction.java 83559 2013-04-30 19:03:29Z murthy@etudes.org $ 
 *********************************************************************************** 
 * 
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (currentSite != null)
		{
			...
			if (jforumToolConfiguration != null)
			{
				...
				context.put("pmUrl", siteNavUrl +"/pm/inbox/date/d"+ SystemGlobals.getValue(ConfigKeys.SERVLET_EXTENSION));
