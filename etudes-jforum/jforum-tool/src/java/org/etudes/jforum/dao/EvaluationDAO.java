/*********************************************************************************** 
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-tool/src/java/org/etudes/jforum/dao/EvaluationDAO.java $ 
 * $Id: EvaluationDAO.java 83559 2013-04-30 19:03:29Z murthy@etudes.org $ 
 *********************************************************************************** 
 * 
...
public interface EvaluationDAO
{
	...
	/**
	 * Updates the user reviewed date
	 * 
	 * @param evaluation	Evaluation object
	 * 
	 * @throws Exception
	 */
	public void updateUserReviewedDate(Evaluation evaluation) throws Exception;
