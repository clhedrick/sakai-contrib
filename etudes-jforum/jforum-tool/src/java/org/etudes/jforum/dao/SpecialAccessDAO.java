/*********************************************************************************** 
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-tool/src/java/org/etudes/jforum/dao/SpecialAccessDAO.java $ 
...
public interface SpecialAccessDAO
{
	...
	/**
	 * Selects the special access by topic
	 * @param forumId		Forum id
	...
	/**
	 * Selects the forum topics special access by forum
	 * @param forumId		Forum id
	 * @return				Special access list
	 * @throws Exception
	 */
	...
	/**
	 * Select the special access for a site or course
	 * @return					Special access
	 * @throws Exception
	 */
	...
	/**
	 * Gets the topic special access count
	 * @param forumId		Forum id
	 * @param topicId		Topic id
	 * @return				Count of the special access for the topic
	 * @throws Exception
	 */
