/*********************************************************************************** 
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-tool/src/java/org/etudes/jforum/entities/Grade.java $ 
...
public class Grade implements Serializable
{
	...
	private boolean minimumPostsRequired;
	...
	public Grade(Grade grade)
	{
		...
		this.minimumPostsRequired = grade.isMinimumPostsRequired();
		this.minimumPosts = grade.getMinimumPosts();
	}
