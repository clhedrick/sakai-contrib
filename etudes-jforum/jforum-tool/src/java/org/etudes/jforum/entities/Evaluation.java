/*********************************************************************************** 
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-tool/src/java/org/etudes/jforum/entities/Evaluation.java $ 
...
public class Evaluation implements Serializable
{
	...
	public Evaluation(Evaluation e)
	{
		...
		this.evaluatedBy = e.getEvaluatedBy();
		this.evaluatedDate = e.getEvaluatedDate();
		this.gradeId = e.getGradeId();
		this.userId = e.getUserId();
		this.userFirstName = e.getUserFirstName();
		this.userLastName = e.getUserLastName();
		this.sakaiUserId = e.getSakaiUserId();
		this.sakaiDisplayId = e.getSakaiDisplayId();
		this.totalPosts = e.getTotalPosts();
		this.released = e.isReleased();
		this.username = e.getUsername();
		this.userSakaiGroupName = e.getUserSakaiGroupName();
		this.reviewedDate = e.getReviewedDate();
	}
