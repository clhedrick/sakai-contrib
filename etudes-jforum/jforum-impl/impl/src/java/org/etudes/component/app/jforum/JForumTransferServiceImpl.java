/*********************************************************************************** 
 * $URL: https://source.sakaiproject.org/contrib/etudes/sakai-jforum/tags/2.9.11/jforum-impl/impl/src/java/org/etudes/component/app/jforum/JForumTransferServiceImpl.java $ 
 * $Id: JForumTransferServiceImpl.java 83559 2013-04-30 19:03:29Z murthy@etudes.org $ 
 *********************************************************************************** 
 * 
...
import org.etudes.api.app.jforum.JForumTransferService;
...
public class JForumTransferServiceImpl implements JForumTransferService, EntityTransferrer, EntityProducer
{

	/** Dependency: a logger component. */
	private static Log logger = LogFactory.getLog(JForumTransferServiceImpl.class);
	...
	{
		if (logger.isInfoEnabled())
			logger.info("Entering megre.....");

		StringBuffer results = new StringBuffer();

		if (logger.isInfoEnabled())
			logger.info("Exiting megre.....");
		return results.toString();
	}
